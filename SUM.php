        ...
        <div id="content">
            ...
            <form name="search_info" method="post" accept-charset="UTF-8">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="exampleFormControlSelect2" name='option2'>
                    <option></option>
                    <option>MAX</option>
                    <option>MIN</option>
                    <option>SUM</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name='textarea1' id="exampleFormControlTextarea1" >SELECT operator(VA_age) FROM voice_actor VA,animation_characteristics AC WHERE VA.VA_id=AC.VA_id AND AC.animation_name= AND AC.year= ; SELECT VA_name,VA_age FROM voice_actor VA WHERE VA.VA_id IN (SELECT VA_id FROM animation_characteristics AC WHERE AC.animation_name= AND AC.year= )</textarea>                
                ...
                <script>
                    function processFormData(){
                        ...
                        var name = res[0];
                        var yr = res[1];
                        const opElement = document.getElementById("exampleFormControlSelect2");
                        const op = opElement.value; 
                        document.getElementById("exampleFormControlTextarea1").value = "SELECT "+op+"(VA_age) FROM voice_actor VA ,animation_characteristics AC WHERE VA.VA_id=AC.VA_id AND AC.animation_name='"+name+"' AND AC.year='"+yr +"';"+"SELECT VA_name,VA_age FROM voice_actor VA WHERE VA.VA_id IN (SELECT VA_id FROM animation_characteristics AC WHERE AC.animation_name= '"+name+"' AND AC.year='"+yr +"')";
                    }
                </script>
            </form>
