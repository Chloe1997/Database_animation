        ...
        <div id="content">
            ...
            <form name="search_info" method="post" accept-charset="UTF-8">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name='textarea1' id="exampleFormControlTextarea1" >SELECT VA_name,VA_age,VA_gender FROM voice_actor VA WHERE VA.VA_id NOT IN (SELECT VA_id FROM dubbing WHERE dubbing.animation_name= AND dubbing.year= );</textarea>                
                ...
                <script>
                    function processFormData(){
                        ...
                        var name = res[0];
                        var yr = res[1];
                        document.getElementById("exampleFormControlTextarea1").value = "SELECT VA_name,VA_age,VA_gender FROM voice_actor VA WHERE VA.VA_id NOT IN (SELECT VA_id FROM dubbing WHERE dubbing.animation_name= '"+name+"' AND dubbing.year='"+yr +"');";
                    }
                </script>
            </form>
