        ...
        <div id="content">
            ...
            <form name="search_info" method="post" accept-charset="UTF-8">
                <div class="form-group">
                    <label for="exampleFormControlSelect1">經紀公司名稱:</label>
                    <select class="form-control" name='option'id="exampleFormControlSelect1" >
                      <option></option>
                    <?php
                        include("connectMysql.php");
                        $sql = "SELECT company_name FROM management_company";
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name='textarea1' id="exampleFormControlTextarea1" >SELECT VA_name,VA_age,VA_gender FROM voice_actor VA WHERE VA.company_id IN (SELECT company_id FROM management_company MC WHERE MC.company_name= );</textarea>                
                ...
                <script>
                    function processFormData(){
                        ...
                        document.getElementById("exampleFormControlTextarea1").value = "SELECT VA_name,VA_age,VA_gender FROM voice_actor VA WHERE VA.company_id IN (SELECT company_id FROM management_company MC WHERE MC.company_name= '"+column+ "');";
                    }
                </script>
            </form>
