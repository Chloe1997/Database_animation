        ...
        <div id="content">
            ...
            <form name="search_info" method="post" accept-charset="UTF-8">
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Column</label>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name='textarea1' id="exampleFormControlTextarea1" >SELECT * FROM animation</textarea>                
                ...
                <div>
                    ...
                    <?php
                        ...
                        <thead class="thead-table-hover">
                            <tr>
                                <th scope="col">動漫名稱</th>
                                <th scope="col">年份</th>
                                <th scope="col">播放方式</th>
                                <th scope="col">題材</th>
                                <th scope="col">集數</th>
                                <th scope="col">原案作品名稱</th>
                                <th scope="col">原案作者</th>
                                <th scope="col">音效指導</th>
                                <th scope="col">錄音工作室營業編號</th>
                            </tr>
                        </thead>
                        <tbody>
                    <?php
                ...
                <script>
                    function processFormData(){
                        ...
                        const operatorElement = document.getElementById("exampleFormControlSelect2");
                        const operator = operatorElement.value;
                        const valueElement = document.getElementById("exampleFormControlInput1");
                        const value = valueElement.value;
                        if (column == ""){
                            document.getElementById("exampleFormControlTextarea1").value = "SELECT * FROM animation;";
                        }else{
                            document.getElementById("exampleFormControlTextarea1").value = "SELECT * FROM animation WHERE "+column+" "+operator+" '"+value+ "';";
                        }
                    }
                </script>
            </form>
