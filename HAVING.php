        ...
        <div id="content">
            ...
            <form name="search_info" method="post" accept-charset="UTF-8">
                <div class="form-group">
                  <label for="exampleFormControlSelect1">SUM/AVG</label>
                  <select class="form-control" id="exampleFormControlSelect1" name='fu'>
                    <option></option>
                    <option>SUM</option>
                    <option>AVG</option>
                  </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="exampleFormControlSelect2" name='col'>
                      <option></option>
                      <option>VA_age</option>
                      <option>term_of_contact</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name='textarea1' id="exampleFormControlTextarea1" >SELECT company_id, SUM() FROM voice_actor GROUP BY company_id HAVING </textarea>                
                ...
                <div>
                    ...
                    <?php
                        ...
                        $select_fu = $_POST["fu"];
                        $select_col = $_POST["col"];   
                            ?>
                        <table class="table">
                        <thead class="thead-table-hover">
                            <tr>
                                <th scope="col">公司</th>
                                <th scope="col"><?php echo $select_fu; ?> ( <?php echo $select_col; ?> ) </th>
                            </tr>
                        </thead>
                        <tbody>
                    <?php
                            ...
                            if(mysqli_num_rows($result)){
                                while($row=mysqli_fetch_array($result)){       			
                                    $sql2 = "SELECT company_name FROM management_company MC WHERE MC.company_id= '$row[0]'";
                                    // echo "<tr>$sql2</tr>";
                                    $result2=mysqli_query($db_link,$sql2) or die("Query Fail! ".mysqli_error($db_link));
                                    $company_name = mysqli_fetch_array($result2)[0];
                                    echo "<tr>
                                        <td>$company_name</td> 
                                        <td>$row[1]</td>
                                        </tr>";     
                ...
                <script>
                    function processFormData(){
                        const FuElement = document.getElementById("exampleFormControlSelect1");
                        const Fu = FuElement.value;
                        ...
                        document.getElementById("exampleFormControlTextarea1").value = "SELECT company_id, "+Fu+"("+column+") "+"FROM voice_actor GROUP BY company_id HAVING "+Fu+"("+column+") "+operator+" "+value+";";
                    }
                </script>
            </form>
